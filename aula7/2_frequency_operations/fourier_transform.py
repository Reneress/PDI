...
def main():
    #lena_image = imread('newspaper_shot_woman.tif')   
    lena_image = imread('len_periodic_noise.png') 
    ...
    #plt.savefig('woman-fourier-amplitude.png', bbox_inches='tight', pad_inches=0)
